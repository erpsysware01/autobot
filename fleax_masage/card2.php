...
$jsonFlex = [
  ...
  "type"=> "imagemap",
  "baseUrl"=> "https://select2web-autobot-bantan.herokuapp.com/imagemap/4001?_ignored=",
  "altText"=> "ค่าใช้จ่ายอื่นๆ",
  "baseSize"=> [
    "width"=> 1040,
    "height"=> 769
  ],
  "actions"=> [
    ...
    [
      ...
      "text"=> "สนับสนุนภารกิจ สถาบันสุรินทร์ พิศสุวรรณ"
    ]
  ]
